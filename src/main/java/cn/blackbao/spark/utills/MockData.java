...
public class MockData {
	 ...
	 */
	public static void mock(JavaSparkContext sc, SparkSession sparkSession) throws AnalysisException {
...
//		Dataset<Row> sql = sparkSession.sql("select * from user_visit_action  where date > '2018-04-14'");
//		
...
//		List<Row> list2 = df2.collectAsList();
//		for(Row _row : list2) {
...
//		 */
		...
		df3.createTempView("product_info");
//		List<Row> list3 = df3.collectAsList();
//		for(Row _row : list3) {
//			System.out.println(_row);  
//		}
	}
