...
//		SQLContext sqlContext = new SQLContext(sc.sc());
		...
		Dataset<Row> dataFrame = spark.createDataFrame(gradeRowsRDD, schema);
		try {
			dataFrame.createGlobalTempView("grades");
		} catch (AnalysisException e) {
			e.printStackTrace();
		}
//		 gradesDF = sqlContext.createDataFrame(gradeRowsRDD, schema);
